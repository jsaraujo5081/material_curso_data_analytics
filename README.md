# Material para Curso Data Analytics (in progress)

El repositorio ha sido desarrollado a partir de mi experiencia dictando talleres y seminarios sobre analítica avanzada. Por esta razón cuenta con recursos para el desarrollo de habilidades técnicas necesarias en la carrera de análisis de datos. Permite comprender y practicar desde conceptos básicos de programación, hasta aspectos de estadística aplicada y visualización avanzada, abarcando las siguientes temáticas a partir de ejercicios y casos de uso aplicados:
